...
; Trigger specific
(only_once_kw) @emphasis.strong
(_when_event ["use" "item" "ability" "act" "talk"
    "on" "enter" "leave" "take" "insert" "into"
    "room" "npc" "interaction" "give" "to" "from"
    "unlock" "look" "at" "open" "drop" "drink" "eat"
    "inhale" ] @function)
(when_cond (always_event) @function.builtin)
